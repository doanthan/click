 ...
 * max-1600 JPG and writes to the public Supabase `avatars` bucket under
 * `events/<uuid>.jpg`. Each call writes a fresh key so client-side removal
 * just orphans the object.
 *
