...
// logging out first — or signs you out into the "Not signed in" state. The root
// layout only mounts it in local development, and every related server action
// is independently protected by assertLocalDevelopment.
//
// Two variants:
