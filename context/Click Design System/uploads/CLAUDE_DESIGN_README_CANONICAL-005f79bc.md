<!-- CORRECTED + CONSOLIDATED design-system README for the claude-design project. Updated 28 Jun 2026 (Your-clicks cards carry no state pill; acquisition CTA "Request an invite" + out-of-area never blocked; no-rejection-angle framing rule [§5b]; "in real life / IRL" encouraged phrase + @click.irl handle). Paste this in to REPLACE the project's current README.md. It mirrors the canonical Click specs (CLICK_PALETTE / CLICK_TYPE / CLICK_LANGUAGE + UIUX/Cowork/*). On any conflict, those canonical specs win and THIS file is corrected to match — never the other way around. -->
