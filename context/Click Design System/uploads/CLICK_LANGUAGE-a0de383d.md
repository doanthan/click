...
| **in real life / IRL** | The whole point — connection happens in person, over shared activities, not through a screen | "in real life" in sentence case; "IRL" all-caps | ENCOURAGED brand phrase. Spell out **"in real life"** in primary/explanatory copy (warmer, clearer); **"IRL"** is fine in social, short, or playful contexts. The social handle is **@click.irl**. Don't overuse — one strong "in real life" per page beats sprinkling "IRL" everywhere. Pairs with the thesis (§ How It Works / WHY IT WORKS): real connection is built in person, more than once. |
...
## 5b. Framing rule — no rejection angle (marketing/explanatory copy)

Many of the people Click is for hold back because of **fear of rejection**. The product is structurally safe (a one-way click is never shown to anyone), but in *marketing and explanatory* copy the answer is **not to talk about it** — it's to sell the positive and keep the click curious. Two opposite mistakes both put rejection on the page:

1. **Planting the could-be-no** — "tells you if it was mutual", "find out if they liked you back". Implies the no.
2. **Over-correcting by naming the safety** — "no one ever gets turned down", "a one-way click is never shown to anyone", "nothing is rated or ranked", "you're never on display", "nothing to risk by hoping". This is defensive and *un-curious*; it raises rejection just to deny it, and it explains the machine (breaks magic-protection).

**The rule:** lead with **desire** (how people actually connect — shared interests, being in the same room) and keep the click **curious** (tease it; "that's all we'll say - the rest is more fun to find out"). Let safety be *felt* through tone — quiet, private, in control, rare — not stated.

| Don't (either failure mode) | Do (desire-led + curious) |
|---|---|
| "...tells you if the feeling was mutual" | "the people you'll click with are already there" |
| "no one ever gets turned down" / "nothing to risk by hoping" | "then there's the click" (tease, don't reassure) |
| "a one-way click is never shown to anyone" (on a marketing page) | "Click keeps that quiet until it's mutual" |
| "you're never rated or on display" | "no swiping, no endless chat, just real life" |

**Scope:** this is for marketing/explanatory surfaces (Landing, How It Works). The tiny in-product anonymity helper at the moment of clicking — "🔒 Clicking is anonymous — we'll only show you if it's mutual." — stays; there a one-line reassurance genuinely helps at the point of action.

Also: **welcome quiet/introverted readers by making them feel safe, never by labelling them** — no "for the shy", "for the lonely", "beat your social anxiety", "find your tribe". Show the calm; don't name the wound.

**State intent-neutrality POSITIVELY, never by negation.** Welcome every intention as equal — ✅ "Friends, something more, or just a fuller social life: it all works the same." ❌ "never framed as dating" / "this isn't a dating app" (defining by what it's NOT plants the word and sounds defensive). Friends-first, dating one of several, never privileged.
