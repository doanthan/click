...
- MUTUAL / COORDINATION MOMENT banner — 🔴 **STATE-AWARE (Cindy 28 Jun): it surfaces whichever mutual needs YOUR next action, with the action verb in the button (visibility of system status + one next step).** Never nags about "waiting on them" states — those rest in Your clicks.
  ...
  • **post-event prompt** → eyebrow "LAST NIGHT · [EVENT]" · title "Did you click with anyone?" · sub "No rush - just the people who were there." · "See who was there" + quiet "Maybe later".
  • **fresh mutual (no plan yet)** → eyebrow "IT'S MUTUAL" · title "You clicked with [Name]. ✨" · sub "Skip the small talk - pick something, meet there." · primary **"Suggest a plan →"**.
