...
=== THE SIGNATURE: a dictionary definition ===
The hero is the dictionary entry for the word "click". Set it like a real, beautiful dictionary entry — this is the whole identity and the hook.
  click   ← the wordmark, large, Poppins, Deep Purple #3B2F81, lowercase
  /klɪk/ · verb   ← phonetic + part-of-speech, Slate, smaller, the body font, a touch of italic
  "to connect effortlessly with someone through shared curiosity, energy, or experience."   ← the definition, Ink, generous
  We help people click in real life — not just online.   ← the positioning line, one notch up in weight
Treat it editorially: a thin hairline rule (Mist) under the entry, real typographic rhythm, lots of negative space. The single spark ✨ (the brand mark) appears once, tastefully, near the wordmark — never as decoration sprinkled around.
...
5. At the very bottom, one understated line for the supply side: "Run events in Sydney? Host on Click →". (Hosting is free during the pilot — NO "founding venue/merchant" programme exists.)
6. Minimal footer (logo, a couple of links). No nav bar clutter, no feature grid, no testimonials wall.
...
2. Primary CTA shifts to "Get in" / "Sign up" (events are now the pull; the CTA leads to signup/onboarding).
3. The merchant line and minimal footer stay.
