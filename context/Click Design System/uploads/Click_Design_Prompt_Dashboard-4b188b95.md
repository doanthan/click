...
- MUTUAL MOMENT banner: headline "You clicked with [Name]. ✨" (the one ✨ peak) + subline "Skip the small talk - pick something, meet there." + primary "Suggest a plan →" (same Button as above).
