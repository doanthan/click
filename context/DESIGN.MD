<!-- Last updated: 2026-06-19 | Revision: v1 (new canonical palette doc) -->
...
- **On cream `#F9F6F0`:** ink, slate, deep purple, teal, and sage all clear AA for text. Coral and amber are **badge/large-text only** on cream — they do not reliably clear 4.5:1 as body text. Don't set caption-size body copy in coral or amber.
